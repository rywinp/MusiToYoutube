...
export default function Footer() {
    return (
        <footer className="absolute bottom-0 bg-orange-50 border-2 border-black rounded-lg p-4 m-4">
            <div className="relative mx-auto max-w-screen-xl px-4 ">
                ...
                <div className="lg:flex lg:items-end lg:justify-between items-center">
                    ...
                    <div className="mr-5">
                        ...
                        If you would like to contact me, reach out to my socials here!`}
                        </p>
                    </div>


                    <Link href={"https://www.linkedin.com/in/rywinp/"} className="mr-4">
                        <Image src={"/linkedin.png"} alt="LinkedIn Icon" width={50} height={50} className=""/>
                    </Link>



                    <Link href={"mailto:rywinp@umich.edu"} className="ml-4">
